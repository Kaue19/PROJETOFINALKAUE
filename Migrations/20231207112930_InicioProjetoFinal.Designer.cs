...
namespace ProjetoFinalKaue.Migrations
{
    ...
    [Migration("20231207112930_InicioProjetoFinal")]
    partial class InicioProjetoFinal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Colaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.LocalRealizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Procedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.ProcedimentoRealizado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.TipoColaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.TipoProcedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalKaue.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalKaue.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalKaue.Models.TipoColaborador", "TipoColaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalKaue.Models.TipoProcedimento", "TipoProcedimento")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalKaue.Models.ProcedimentoRealizado", b =>
                {
                    b.HasOne("ProjetoFinalKaue.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId");

                    b.HasOne("ProjetoFinalKaue.Models.Colaborador", "Colaborador")
                        .WithMany()
                        .HasForeignKey("ColaboradorId");

                    b.HasOne("ProjetoFinalKaue.Models.LocalRealizacao", "LocalRealizacao")
                        .WithMany()
                        .HasForeignKey("LocalRealizacaoId");

                    b.HasOne("ProjetoFinalKaue.Models.Procedimento", "Procedimento")
                        .WithMany()
